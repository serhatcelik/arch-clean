# Generated by Powerlevel10k configuration wizard on 2024-03-11 at 07:53 +03.
...
() {
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green (76) prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=
  # Red (196) prompt symbol if the last command failed.
  ...
  # Use full signal names: "SIGINT(2)" instead of "INT".
